                ...
                <div className="card">
                  <div className="card-header p-3 pt-2">
                    ...
                    <div className="text-end pt-1">
                      <p className="text-sm mb-0 text-capitalize">Total Earnings</p>
              ...
              <div className="col-xl-4 col-sm-6 mb-xl-0 mb-4">
                <div className="card">
                  <div className="card-header p-3 pt-2">
                    ...
                    <div className="text-end pt-1">
                      <p className="text-sm mb-0 text-capitalize">Advance Taken</p>
                      <h4 className="mb-0">0</h4>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-xl-4 col-sm-6">
                <div className="card">
                  <div className="card-header p-3 pt-2">
                    ...
                    <div className="text-end pt-1">
                      <p className="text-sm mb-0 text-capitalize">Remaining Salary</p>
                      <h4 className="mb-0">0</h4>
                    </div>
                  </div>
                </div>
